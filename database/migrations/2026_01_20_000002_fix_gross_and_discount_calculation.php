...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        BEGIN
            ...
            -- Buscar valores líquidos separadamente para simples e kit
            SELECT COALESCE(SUM(si.total_value),0)
            ...
            -- Calcular descontos: bruto - líquido (positivo)
            v_total_discount_simple := v_total_simple_value - v_total_simple_net;
            v_total_discount_kit := v_total_kit_value - v_total_kit_net;
