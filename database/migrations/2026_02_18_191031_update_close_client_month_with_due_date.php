...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        DECLARE
            ...
            v_client_closure_created_at DATE;
            v_closure_created_at DATE;
            v_due_date DATE;
        ...
        BEGIN
            ...
            -- Se não encontrar preço, usar valores padrão
            IF v_unit_simple IS NULL THEN
                v_unit_simple := 0;
            END IF;
            IF v_unit_kit IS NULL THEN
                v_unit_kit := 0;
            END IF;

            SELECT created_at::DATE
            INTO v_closure_created_at
            FROM monthly_closures
            WHERE year = p_year
            AND month = p_month;
            ...
            -- Calcular descontos como valor absoluto: |bruto - líquido|
            v_total_discount_simple := ABS(v_total_simple_net - v_total_simple_value);
            v_total_discount_kit := ABS(v_total_kit_net - v_total_kit_value);

            v_total_liquid_labels := v_total_simple_value + v_total_kit_value;

            v_total_gross := v_total_original_labels + v_total_superkit;
            v_total_discount := v_total_discount_simple + v_total_discount_kit;
            v_total_net := v_total_gross - v_total_discount;
            ...
            INTO v_client_closure_created_at, v_closure_client_id
            ...
            v_due_date := add_business_days(
                v_client_closure_created_at,
                5
            );

            UPDATE monthly_closure_clients
            SET due_date = v_due_date,
                updated_at = NOW() AT TIME ZONE 'America/Sao_Paulo'
            WHERE id = v_closure_client_id;
            ...
            INSERT INTO monthly_closure_shipments (closure_client_id, shipment_id, created_at, updated_at, old_status)
            SELECT
                v_closure_client_id,
                s.id,
                NOW() AT TIME ZONE 'America/Sao_Paulo',
