...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        CREATE OR REPLACE PROCEDURE close_client_month(
            p_client_id INT,
            p_year INT,
            p_month INT
        )
        ...
        DECLARE
            ...
            v_total_simple_gross NUMERIC(10,2) := 0;
            v_total_kit_gross NUMERIC(10,2) := 0;
        ...
        BEGIN
            ...
            v_total_liquid_labels := (v_total_simple * v_unit_simple) + (v_total_kit * v_unit_kit);

            v_total_simple_gross := v_total_simple * v_unit_simple;
            v_total_kit_gross := v_total_kit * v_unit_kit;
            v_total_discount_simple := v_total_simple_gross - (v_total_simple * v_unit_simple);
            v_total_discount_kit := v_total_kit_gross - (v_total_kit * v_unit_kit);
            ...
            VALUES (
                ...
                v_unit_simple,
                v_unit_kit,
                v_total_simple * v_unit_simple,
                v_total_kit * v_unit_kit,
                v_total_superkit,
                v_total_simple_gross,
                v_total_kit_gross,
                v_total_gross,
                v_total_discount,
    ...
    {
        // A migration anterior pode ser revertida se necessário
    }
};
