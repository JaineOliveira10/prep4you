<div class="flex align-items-center list-price-tables-action">
    <a class="btn btn-sm btn-icon btn-info" data-bs-toggle="tooltip" title="Ver produto" href="{{ route('products.show',$id) }}">
    ...
    <a class="btn btn-sm btn-icon btn-warning" data-bs-toggle="tooltip" title="Editar produto" href="{{ route('products.edit',$id) }}">
        <span class="btn-inner">
            <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
