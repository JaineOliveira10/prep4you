<div class="flex align-items-center list-user-action">
    ...
    <a class="btn btn-sm btn-icon btn-danger" onclick="confirmDelete('user-delete-{{$id}}', 'Deseja realmente excluir este usuário?')" data-bs-toggle="tooltip" title="Excluir usuário" href="#">
        <span class="btn-inner">
