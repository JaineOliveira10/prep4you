                            ...
                            <div class="new-shipment-info">
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" name="shipment_code" id="shipment_code" class="form-control" value="{{ old('shipment_code', $data->shipment_code ?? '') }}" placeholder="Digite o id da remessa" required>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-md-6">
