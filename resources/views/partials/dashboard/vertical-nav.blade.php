<ul class="navbar-nav iq-main-menu"  id="sidebar">
    ...
    <li class="nav-item static-item">
        <a class="nav-link static-item disabled" href="#" tabindex="-1">
            <span class="default-icon">Usuários</span>
            <span class="mini-icon">-</span>
        </a>
    </li>
    ...
    <li class="nav-item">
        ...
        <ul class="sub-nav collapse" id="sidebar-user" data-bs-parent="#sidebar">
            <li class="nav-item">
                <a class="nav-link {{activeRoute(route('users.show', auth()->user()->id))}}" href="{{route('users.show', auth()->user()->id)}}">
                    <i class="icon">
            ...
            <li class="nav-item">
                <a class="nav-link {{activeRoute(route('users.index'))}}" href="{{route('users.index')}}">
                    ...
                    <span class="item-name">Gerenciar Usuários</span>
                </a>
            </li>
            @endif
        </ul>
    ...
    <li class="nav-item static-item">
        <a class="nav-link static-item disabled" href="#" tabindex="-1">
            <span class="default-icon">Tabelas de preços</span>
            <span class="mini-icon">-</span>
        </a>
    </li>

     <li class="nav-item">
        <a class="nav-link {{activeRoute(route('price-tables.index'))}}" href="{{route('price-tables.index')}}">
            <i class="icon">
    ...
    <li class="nav-item static-item">
     ...
     <li class="nav-item">
        <a class="nav-link {{activeRoute(route('distribution-centers.index'))}}" href="{{route('distribution-centers.index')}}">
            <i class="icon">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" viewBox="0 0 24 24" fill="currentColor">
                    <path d="M20 8h-3V4H3v13h2a3 3 0 0 0 6 0h4a3 3 0 0 0 6 0h1v-5l-2-4zm0 2.5 1.5 3H17v-3h3zM8 18.5A1.5 1.5 0 1 1 8 15a1.5 1.5 0 0 1 0 3.5zm10 0A1.5 1.5 0 1 1 18 15a1.5 1.5 0 0 1 0 3.5z"/>
                </svg>


            </i>
            <span class="item-name">Centros Distribuição</span>
        </a>
    </li>
    @endif
    ...
    <li class="nav-item static-item">
        <a class="nav-link static-item disabled" href="#" tabindex="-1">
            <span class="default-icon">Fechamento Mensal</span>
            <span class="mini-icon">-</span>
        </a>
    </li>
    <li class="nav-item">
        <a class="nav-link {{activeRoute(route('monthly-closures.index'))}}" href="{{route('monthly-closures.index')}}">
            <i class="icon">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" viewBox="0 0 24 24" fill="currentColor">
                    <path d="M19 3h-1V1h-2v2H8V1H6v2H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm0 16H5V8h14v11z"/>
                </svg>
            </i>
            <span class="item-name">Fechamento Mensal</span>
        </a>
    </li>
    @endif