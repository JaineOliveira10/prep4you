<x-app-layout :assets="$assets ?? []">   <div class="row mb-4">
      ...
      @if(isset($unpaidClosures) && $unpaidClosures > 0)
         @foreach ($unpaidClosuresList as $closure)
            <div class="col-lg-3 col-md-6 mb-3">
                  ...
                  <div class="card-body p-4">
                     ...
                     <p class="mb-2">
                        ...
                        <span class="fw-bold" style="color: #17a2b8;">
                           {{ str_pad($closure->month, 2, '0', STR_PAD_LEFT) }}/{{ $closure->year }}
                        </span>
                        <br>
                        Vr. Líquido:
                        <span class="fw-bold" style="color: #17a2b8;">
                           R$ {{ number_format($closure->closureClient->total_net, 2, ',', '.') }}
                     ...
                     <a href="#"
                        onclick="confirmNewClosure(
                           { closure_id: {{ $closure->id }}, client_id: {{ $client }} },
                           'Download do PDF iniciado!'
                        ); return false;"
                        style="font-size: 0.9rem;">
                        Clique aqui para realizar pagamento
                     </a>
