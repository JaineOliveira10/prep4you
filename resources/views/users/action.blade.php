    ...
    <a class="btn btn-sm btn-icon btn-info" data-bs-toggle="tooltip" title="{{auth()->id() != $user->id ? 'Ver dados do usuário' : 'Ver meu perfil' }}" href="{{ route('users.show',$id) }}">
        <span class="btn-inner">
            <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path fill-rule="evenodd" clip-rule="evenodd" d="M9.8766 11.886C12.3996 11.886 14.4446 9.841 14.4446 7.318C14.4446 4.795 12.3996 2.75 9.8766 2.75C7.3546 2.75 5.3096 4.795 5.3096 7.318C5.3096 9.841 7.3546 11.886 9.8766 11.886Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
            </svg>
        </span>
    </a>
